...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('🔍 Gʀᴏᴜᴘ', url="https://t.me/+nAmW2gwVIYc2YTFl"),
                    InlineKeyboardButton('🎬 channel', url='https://t.me/KH_NEW_MOVIES_PROVIDER')
                ],[
            ...
            try:
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton('Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ', url=f'https://t.me/KH_NEW_MOVIES_PROVIDER'),
                                InlineKeyboardButton('Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ', url=f'https://t.me/KH_NEW_MOVIES_PROVIDER')
                            ],[
