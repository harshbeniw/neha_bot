...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         ...
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=f"https://t.me/+nAmW2gwVIYc2YTFl")]])
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ Lɪɴᴋ", url="https://t.me/+nAmW2gwVIYc2YTFl")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
    ...
    # don't change anything without contacting me @creatorrio
        ...
        buttons = [[
            InlineKeyboardButton('🫵 SUBSCRIBE 🫵', url="https://www.youtube.com/@YTREDSTARE"),
        ],[
            InlineKeyboardButton('🍀 Movie Search Group 🍀', url="https://t.me/+nAmW2gwVIYc2YTFl")
        ],[
            InlineKeyboardButton('🍂 Movie channel 🍂', url="https://t.me/KH_NEW_MOVIES_PROVIDER")
        ],[
            InlineKeyboardButton('🍁 Bots Update Channel 🍁', url="https://t.me/KH_NEW_MOVIES_PROVIDER")
        ],[
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="help"),
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="telegram.me/Bot_father_lover")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
